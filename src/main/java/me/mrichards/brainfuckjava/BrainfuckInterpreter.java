...
public class BrainfuckInterpreter {
    ...
    public static void main(String[] args) throws IllegalTokenException, IOException, IllegalArgumentException {
        if (args.length < 2) {
            throw new IllegalArgumentException("Wrong number of arguments. Use -f <file_name>, or -r <code>.");
        }
